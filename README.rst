...
**Note:** An official `fix <https://docs.python.org/3.6/whatsnew/changelog.html>`_ for this issue was released in Python 3.6.0. This package now acts as a backport for all older versions of python.
